 ...
 *
 * REQUISITO: cargar el CDN de supabase-js ANTES de este script:
...
(function () {
  ...
  // El CDN UMD expone `window.supabase` con { createClient }
  if (typeof window.supabase === "undefined" || !window.supabase.createClient) {
    console.error("[supabase.js] La librería supabase-js no está cargada.");
    return;
  }
